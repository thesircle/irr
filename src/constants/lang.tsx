        ...
        KASEYA: {
            ...
            TUT_3: {
                ...
                props:[
                    {
                        key : "7",
                        value: "Create a new account by entering a Username and Password. (Make sure that there is a CW member with Admin rights already available with the same username)."
                    },
                    {
                        key : "8",
